...
| The Force & the Fight — Complete Compendium | [compendium.html](https://recoson.github.io/Star-wars-GURPS-campaign/compendium.html) |
...
- **Ships & droids: components ARE the health.** No HP pools — shields soak → DR (÷AD) → Damage Threshold degrades the struck system (● → ◐ → ✕). Vaporisation at ≥6×DT. Ion: ×2 vs shields, never structural.
